    ...
    <div class="content">
                    ...
                    <div class="col-xs-12">
                        <div class="well well-sm">
                            <div class="user-profile-card">
                                ...
                                <div class="panel-footer"><a href="./my_account_edit"
                                        data-original-title="Edit My Profile" data-toggle="tooltip" type="button"
                                        class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-edit"></i> Edit My
                                        Profile</a></div>
                            </div>
                        </div>
                    </div>
            ...
            <form method="post">
                <div class="input-group">
                    <div class="form-outline">
                        <input type="search" name="search_input" value="" placeholder="Search" id="form1"
                            class="form-control" />
        ...
        if (is_array($bookies) || is_object($bookies)):?>
                        ...
                        <tr>
                            ...
                            <td><input type="submit" name="borrow" class="btn btn-success" <?php echo $booky['isbn'];?>
                                    value="Borrow This Book" style="width:auto">
                ...
                <form action="" method="post">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="isbn" id="isbn" min=9000000000 max=9000000000000
                ...
                <?php endforeach ?> -->
                        ...
                        <input type="number" name="pages" id="pages" placeholder="Number of pages" min=5 max=3000
                            required>
                        <input type="number" name="published" id="published" placeholder="Published in the year"
                            length=4 min=1900 max=<?= date('Y')?> required>
                        <input type="submit" name="submit" class="btn btn-success" value="Add to collection"
                            style="width:auto">
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card" style="width:300px">
                    <img src="../View/includes/default_book_cover.jpeg" alt="" class="card-img-top">
                    <!--//TODO ternary operator for book image-->
                    <div class="card-body">
                        <h4 class="card-title">Title something something</h4>
                        <h5 class="card-title">A. Uthor</h5>
                        <p class="card-text">Available</p>
                        <a href="#" class="btn btn-primary">Set unavailable</a>
                        <!--//TODO ternary for available-->
